...
func (adm *AgentService) AgentById(id uint) (*entity.User, []error) {
...
func (adm *AgentService) Agents() ([]entity.User, []error) {
...
func (adm *AgentService) UpdateAgent(agentData *entity.User) (*entity.User, []error) {
...
func (adm *AgentService) StoreAgent(agentData *entity.User) (*entity.User, []error) {
...
func (adm *AgentService) DeleteAgent(id uint) (*entity.User, []error) {
