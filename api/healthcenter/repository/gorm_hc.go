...
func (hcr *HcRepository) HealthCenter(id uint) (*entity.HealthCenter, []error) {
...
func (hcr *HcRepository) HealthCenters(value string, column string) ([]entity.Hcrating, []error) {
	// hcs := []entity.HealthCenter{}
